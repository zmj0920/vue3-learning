<template>
  <div class="text-ellipsis" :title="content">
    {{ textVisible }}
    <span class="text-ellipsis-dots" v-if="isEll && !isExpand">{{ dot }}</span
    ><span v-if="isEll" class="text-ellipsis-action" @click="onActionClick">
